    ...
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ url('Connect/dist/img/user1-128x128.jpg') }}" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ url('Connect/dist/img/user8-128x128.jpg') }}" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ url('Connect/dist/img/user3-128x128.jpg') }}" alt="User Avatar"
                                    class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../../index3.html" class="brand-link">
                <img src="{{ url('Connect/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ url('Connect/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <form action="{{ url('updatebrand') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="md-3">
                                        <label class="form-lebel">Brand ID</label>
                                        <input type="text" class="form-control" name="id"
                                            placeholder="Enter Brand ID" value="{{ $brand->brand_id }}" readonly>
                                        @error('id')
                                    ...
                                    <div class="md-3">
                                        <label class="form-lebel">Brand Name</label>
                                    ...
                                    <a href="{{ url('/Admin/brand') }}" class="btn btn-danger">Back</a>
                                </form>
                            </div>
                        </div>
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
          <form action="{{ route('add_brand') }}" method="post">
            ...
            @endif
            @csrf
            <label for="brand_id">ID Brand:</label>
