...
<head>
  ...
  <title> List account customer</title>
  ...
  <script>
    var showpassBtns = document.querySelectorAll("#showpass");
    showpassBtns.forEach(function(btn) {
        btn.addEventListener("click", function(event) {
            event.preventDefault();
            var passwordCell = event.target.closest("tr").querySelector(".password-cell");
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{url('Connect/dist/img/user1-128x128.jpg')}}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{url('Connect/dist/img/user8-128x128.jpg')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{url('Connect/dist/img/user3-128x128.jpg')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
          ...
          <div class="card card-info">
            ...
            <div class="card-body p-0">
                <table class="table">
                    ...
                    <tbody>
                      <?php $count = ($dataUser->currentPage() - 1) * $dataUser->perPage() + 1; ?>
                        ...
                        <tr>
                            ...
                            <td class="text-right py-0 align-middle">
                                <div class="btn-group btn-group-sm">
                                  ...
                                  <a href="{{ url('delete/' . $User->user_id) }}" class="btn btn-danger" onclick="return confirmDelete()"><i class="fas fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                        <?php $count++; ?>
