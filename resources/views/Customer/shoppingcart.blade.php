	...
	<header class="header-v4">
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="{{url('Customer/shoppingcart')}}" class="label1 rs1" data-label1="hot">Features</a>
				</li>
					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
                                ...
                                <div class="item">
                                    <div class="image">
                                        <img src="{{ $orderDetail->product->image }}" alt="Product Image">
                                    </div>
                                    ...
                                    <div class="total">{{ $orderDetail->price * $orderDetail->quantity }}</div>
                                </div>
                            @endforeach
							</table>
						</div>
